...
const createIcon = (d, defaultSize = 16) => {
    return ({ size = defaultSize, color = 'currentColor', style = {}, className = '', ...props }) => (
        <svg
            width={size}
            height={size}
            viewBox="0 0 24 24"
...
export const HeartIcon = ({ size = 16, color = 'currentColor', fill = 'none', style = {}, ...props }) => (
    <svg
        width={size}
        height={size}
        viewBox="0 0 24 24"
...
export const KeyIcon = createIcon(
    <>
        <path d="M21 2l-2 2m-1.5 1.5L14 9m0 0l-1.5 1.5M14 9l-4-4a6 6 0 1 0-7 7l4 4m7-7l2 2" />
...
export const StatusDot = ({ color = '#52c41a', size = 6, style = {} }) => (
    <span
        style={{
...
export const HeartOffIcon = createIcon(
    <>
        <line x1="2" y1="2" x2="22" y2="22" />
        <path d="M16.5 16.5L12 21l-7-7c-1.5-1.45-2-3.2-2-5 0-1.2.33-2.3 1-3.2m3-1.8c.67-.14 1.35-.14 2 0 1.25.3 2.37 1 3 2 1.06-1.6 2.87-2.3 4.67-1.8 2.38.65 3.83 2.92 3.33 5.3-.23 1.09-.8 2.07-1.61 2.8" />
    </>
);
